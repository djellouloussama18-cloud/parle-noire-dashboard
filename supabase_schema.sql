...
CREATE POLICY "Allow authenticated full access to tournaments" ON public.tournaments FOR ALL USING (auth.role() = 'authenticated');

ALTER TABLE public.participants ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow authenticated full access to participants" ON public.participants FOR ALL USING (auth.role() = 'authenticated');

ALTER TABLE public.matches ENABLE ROW LEVEL SECURITY;
CREATE POLICY "Allow authenticated full access to matches" ON public.matches FOR ALL USING (auth.role() = 'authenticated');
